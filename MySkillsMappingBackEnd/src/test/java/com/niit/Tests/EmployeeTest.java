...
public class EmployeeTest extends TestCase {
	...
	public void setup() {
		...
		emp1.setEmpId(121);
		emp1.setEmpName("AKrishna");
		emp1.setEmpEmail("Akrishna@gmail.com");
		emp1.setEmpMobile("9922411334");	
		emp1.setEmpGender("f");
		emp1.setEmpAddress("arampeth Area");
		...
		emp2.setEmpId(111);
		emp2.setEmpName("rAkshay");
		emp2.setEmpEmail("Rakshay@gmail.com");
		emp2.setEmpMobile("5422125009");	
		emp2.setEmpGender("f");
		emp2.setEmpAddress("aDharampeth Area");
		emp2.setEmpCity("Nagpur");
		emp2.setEmpDob("1/03/1977");
		emp2.setEmpRole("tTrainer");
